...
<html lang="FR">
    ...
    <body class="indexBodyGridContainer" id="indexBody">
        ...
        <nav id="indexNav">
            <button><h1><a href="resume.php">BIOGRAPHY</a></h1></button>
            <button><h1><a href="resume.php#skills">SKILLS</a></h1></button>
            <button><h1><a href="resume.php#formations">FORMATIONS</a></h1></button>
