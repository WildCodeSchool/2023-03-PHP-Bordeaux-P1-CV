...
<html lang="FR">
    ...
    <body class="indexBodyGridContainer" id="indexBody">
        ...
        <nav id="indexNav">
            <button><h2><a href="resume.php">BIOGRAPHIE</a></h2></button>
        ...
        <main>
            ...
            <div>
                ...
                <h3>Recherche le casse du siècle...</h3>
				<p>Je suis bien décidé à dénicher tous les trésors cachés de ce monde, plus le projet est lucratif et plus je suis motivé.</p>
				<p>Je paufine mes techniques de vol depuis de nombreuses années, parfois avec succès, parfois sans mais toujours avec le sourire et détermination.</p>
            </div>
        </main>
